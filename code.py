...
# accessing row attribute of column 'Country_Name'
...
# --------------
#Code starts here
# Create DF where column is equal to columns attribute with one row
best=data[data['Country_Name']==best_country]

best=best[['Gold_Total','Silver_Total','Bronze_Total']]  # subset further to also give gold,siver and bronze

best.plot.bar(stacked=True)

plt.xlabel('United States')
plt.ylabel('Medals Tally')
plt.title('Country With Best Perfomance')
